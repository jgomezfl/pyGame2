...
class shoot(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, timeShooted, direction, bloques, enemies):
        super().__init__()
        ...
        self.BlocksLevel = bloques
        self.EnemiesLevel = enemies
    ...
    def update(self):
        ...
        list_enemies_collided = pygame.sprite.spritecollide(self, self.EnemiesLevel, False)
        for enemy in list_enemies_collided:
            enemy.kill()
            self.kill()
...
class Player(pygame.sprite.Sprite):
    ...
    def attacking(self):
        ...
        if ahora - self.last_shoot > self.cadencia:
            ...
            bullet = shoot(self.rect.x, self.rect.y, self.last_shoot, self.direction, self.BlocksLevel, self.EnemiesLevel)
            bullets.add(bullet)
...
class Enemy(pygame.sprite.Sprite):
    COLOR = (255, 0, 0)
    SPRITES = load_sprite_sheets("Enemy", 32, 32, True)
    ANIMATION_DELAY = 20
    ENEMY_VEL = 2.5
...
class Level2(Level):
    ...
    MAPA = [
        ...
        " , , , , , , , , , , , , ,X, , , , , , , , , , ,X, , , ,X, , , , , , , , ,X, , , ,X, , , , , , , , , ",
        " , , ,X, , , , ,X, , , , , , , , , , , , , , , , , , ,X, , , , , , , , , , ,X, ,E, ,X, , , , , , , ,X, , ,E, , , ,X",
        "X, , ,X, ,E, , , ,X, , , ,X, ,X, , , , , , , , ,X, ,E, ,X, , , , , , ,X, , ,X,X,X,X,X,X, , , , , ,X, ,X,X,X, , , ,X",
    ...
    def __init__(self, player, block_size):
        ...
        for i in self.MAPA:
            ...
            if(blocks[0] != ''):
                ...
                for block in blocks:
                    ...
                    if block == "E":
                        level_enemies.append(Enemy((block_size * cont1)+(block_size/2), HEIGHT - (block_size*cont) - (block_size/2), 70, 70))
                    cont1 += 1
            cont -= 1  
        ...
        for enemy in level_enemies:
            enemy.BlocksLevel = self.block_list
...
def level2(window):
    ...
    if pantalla_actual == "main_menu":
        ...
        level = Level2(player, block_size)  
        player.BlocksLevel = level.block_list
        player.EnemiesLevel = level.enemies
        # enemy = Enemy(100, 100, 70, 70)
        # enemy.BlocksLevel = level.block_list
        ...
        while run:
            for event in pygame.event.get():
                if event.type == pygame.QUIT or event.type == pygame.K_0:
                    run = False
                    break
